...
class Case_Category(models.Model):
    ...
    police_station = models.CharField(max_length=150, null=True)
    case_file = models.FileField(upload_to='case_files/', null=True, blank=True)
...
class Case_request(models.Model):
    ...
    def __str__(self):
        return f"Case: {self.sub} - {self.user_name}"
